package UsovAA.MyUiRestDbService.controller;
...
import UsovAA.MyUiRestDbService.dao.StudentRepository;
import UsovAA.MyUiRestDbService.entity.Student;
...
public class StudentController {
    ...
    public ModelAndView addStudentForm() {
        ...
        Student student = new Student(); // Создаем новый объект Student
        mav.addObject("student", student); // Передаем его в модель
        return mav;
    }
